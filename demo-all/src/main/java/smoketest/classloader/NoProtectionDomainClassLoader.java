 ...
 * a {@link java.security.CodeSource CodeSource}, to mimic IntelliJ's class loading behavior).
 *
...
public class NoProtectionDomainClassLoader extends URLClassLoader {
    ...
    /**
     * Packages that should be loaded by the parent class loader.
     * There's likely more for a proper implementation like org.w3c. but not necessary for this test.
     */
     ...
     * JDK classes are loaded in the parent classloader, others by this classloader.
     *
    ...
    /**
     * Finds and loads the class with the specified name from the URL search path without {@link ProtectionDomain}.
